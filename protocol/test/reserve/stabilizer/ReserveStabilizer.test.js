...
const MockReserveStabilizer = contract.fromArtifact('MockReserveStabilizer');
...
describe('ReserveStabilizer', function () {
  ...
  beforeEach(async function () {
    ...
    this.comptroller = await MockReserveStabilizer.new({from: ownerAddress});
  ...
  // Redemption Tax not enabled in comptroller.
  //
  ...
  //       const event = await expectEvent.inTransaction(this.txHash, MockReserveStabilizer, 'Redeem', {
  //         account: userAddress
  //       });
  //
    ...
    describe('under limit', function () {
      describe('single', function () {
        ...
        it('emits Borrow event', async function () {
          const event = await expectEvent.inTransaction(this.txHash, MockReserveStabilizer, 'Borrow', {
          });
  ...
  describe('settle', function () {
    ...
    describe('basic', function () {
      ...
      it('emits Settle event', async function () {
        const event = await expectEvent.inTransaction(this.txHash, MockReserveStabilizer, 'Settle', {
          account: userAddress
        });
